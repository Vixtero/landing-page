      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="mx-auto max-w-screen-xl px-4 py-8 text-center lg:px-12 lg:py-16">
          <div
            ...
            role="alert"
          >
            <span className="mr-3 rounded-full bg-sky-600 px-4 py-1.5 text-xs text-white">
              Coming Soon
            </span>
            <span className="text-sm font-medium">
              Vixlite is launching soon!
            </span>
          </div>

          <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 dark:text-white md:text-5xl lg:text-6xl">
            Simplify Your Trade Operations with Vixlite
          </h1>
          <p className="mb-8 text-lg font-normal text-gray-500 dark:text-gray-400 sm:px-16 lg:text-xl xl:px-48">
            Vixlite is our upcoming lightweight solution for efficient
    ...
    <section className="bg-sky-50">
      <div className="mx-auto grid max-w-7xl grid-cols-1 place-items-center gap-2 px-6 py-12 md:grid-cols-2 md:gap-8">
        ...
        <Image
          ...
          alt="Automated HS Code and Lartas validation process"
          width={400}
          height={200}
        ...
        <Image
          ...
          alt="Internal approval workflow with Maker, Checker, Approver roles"
          width={400}
          height={200}
        ...
        <Image
          ...
          alt="Automated and dynamic cost calculation for duties, taxes, logistics"
          width={400}
          height={200}
